...
const firstInput = document.querySelector('[data-js="first-input"]'),
  secondInput = document.querySelector('[data-js="second-input"]'),
  uppercaseButton = document.querySelector('[data-js="button-uppercase"]'),
  lowercaseButton = document.querySelector('[data-js="button-lowercase"]'),
  switchButton = document.querySelector('[data-js="button-switch"]');
...
switchButton.addEventListener("click", () => {
  const inputFirst = firstInput.value,
    inputSecond = secondInput.value;

  firstInput.value = inputSecond;
  secondInput.value = inputFirst;
});
